...
Aby utrzymać zasadę zachowania energii, musimy wyraźnie rozróżnić światło rozproszone od zwierciadlanego. W momencie, gdy promień światła trafi na powierzchnię, zostaje podzielony na część <def>refrakcyjną</def> (ang. *refraction*) i część <def>odbitą</def> (ang. *reflection*). Część odbita jest światłem, które bezpośrednio odbija się i nie wchodzi w powierzchnię; to jest to, co znamy jako oświetlenie lustrzane. Częścią refrakcyjną jest pozostała część światła, która wchodzi w powierzchnię i zostaje wchłonięta; to jest to, co znamy jako oświetlenie rozproszone.
